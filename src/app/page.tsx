...
const aboutCardsData = [
  {
    ...
    description:
      "Tackle intriguing design problems and create user-centric solutions that make a real impact.",
  ...
  },
  {
    ...
    description:
      "Bring your ideas to life by building functional prototypes and demos with cutting-edge tools.",
  ...
  },
  {
    ...
    description:
      "Work with talented peers and connect with industry mentors who can guide your journey.",
    className: "md:col-span-2",
  },
];
...
const AboutCard = ({
  ...
  return (
    <Card
      ...
      className={cn(
        "bg-card/50 border-border/50 text-left animate-fade-in-up flex flex-col card-3d-interactive",
        className
      )}
    >
      <CardHeader className="flex-shrink-0">
        <div className="flex items-center gap-4">
          ...
          <CardTitle className="text-2xl font-headline font-light">
            {title}
          </CardTitle>
        </div>
      </CardHeader>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
                SparkLab is where creativity meets innovation in a high-energy,
                30-hour design marathon. We bring together the brightest minds
                to tackle real-world challenges, pushing the boundaries of
